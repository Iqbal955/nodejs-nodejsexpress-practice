...
* Require Helpers
 * 
 * * Change the two helper function calls in the 
 * GET '/' route handler from 'routes.js' to call the `reverseString` and `shortenString` 
 * helper functions from the imported module
*/
